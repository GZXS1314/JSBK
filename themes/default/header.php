...
// 1. 强制引入系统底层数据准备层 (获取 $pdo, $site_config, 用户信息等全局变量)
// 因为 index.php 是入口，所以这里的 __DIR__ 是在主题目录下，需要回退到根目录找 includes
...
<head>
    ...
    <?php if ($is_home): ?>
    <link rel="stylesheet" href="<?= THEME_URL ?>/assets/css/home.css?v=<?= time() ?>">
    <?php endif; ?>
...
<div class="mobile-sidebar" id="mobileSidebar">
    ...
    <div class="m-footer">
        ...
        <a href="<?= THEME_URL ?>/user/dashboard.php" class="m-btn"><i class="fa-solid fa-user-gear"></i> 个人中心</a>
        <a href="<?= THEME_URL ?>/user/logout.php" class="m-btn"><i class="fa-solid fa-power-off"></i> 退出</a>
        <?php else: ?>
...
<nav class="navbar-wrapper">
    <div class="navbar-inner">
        ...
        <div class="nav-right">
            ...
            <?php if($is_user_login): ?>
            <a href="<?= THEME_URL ?>/user/dashboard.php" class="nav-user-btn" style="margin-left: 15px;"><img src="<?= $current_user_avatar ?>" class="nav-avatar"></a>
            <?php else: ?>
