...
$slogan_main = str_replace('&lt;br&gt;', '<br>', htmlspecialchars_decode(conf($theme_prefix.'slogan_main', '人生如棋<br>落子无悔'))); 
$btn1_text = conf($theme_prefix.'btn1_text', '项目');
...
// 使用 THEME_URL 动态输出当前主题的静态资源绝对路径
echo '<script src="' . THEME_URL . '/assets/js/home.js?v=' . time() . '"></script>';
// 引入当前主题的尾部视图
